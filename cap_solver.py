...
if __name__ == "__main__":
    ...
    plt.plot(history.history['val_loss'])#!/usr/bin/env python
# -*- coding:utf-8 -*-
...
if __name__ == "__main__":
    ...
    # initiate Adam optimizer
    opt = keras.optimizers.Adam(lr=0#!/usr/bin/env python
# -*- coding:utf-8 -*-
...
if __name__ == "__main__":
    ...
    scores = model.evaluate(x_test, y_test, verbose=1)
    print('Test loss:     %.2f' % scores[0])
    print('Test accuracy: %.2f' % (scores[1]*100.)).0001, beta_1=0.99, beta_2=0.9999, epsilon=None, decay=0.0, amsgrad=False)
    model.compile(loss='binary_crossentropy',
                  optimizer=opt,
                  metrics=['accuracy'])
